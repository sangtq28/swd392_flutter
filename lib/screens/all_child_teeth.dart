...
import 'package:flutter_swd392/screens/teeth_record.dart';
import '../models/children_model.dart';
import '../repository/children_repository.dart';

class AllChildTeeth extends StatefulWidget {
  const AllChildTeeth({super.key});

  @override
  _AllChildTeethState createState() => _AllChildTeethState();
}

class _AllChildTeethState extends State<AllChildTeeth> {
            ...
            onTap: () async {
              bool? result = await Navigator.push(
                ...
                MaterialPageRoute(builder: (context) =>
                    TeethRecordsScreen(childModel: child)),
              );
