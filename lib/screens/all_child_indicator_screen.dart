...
import 'package:flutter_swd392/screens/grow_chart_screen.dart';
...
class AllChildIndicatorScreen extends StatefulWidget {
  const AllChildIndicatorScreen({super.key});

  @override
  _AllChildIndicatorState createState() => _AllChildIndicatorState();
}

class _AllChildIndicatorState extends State<AllChildIndicatorScreen> {
            ...
            onTap: () async {
              bool? result = await Navigator.push(
                ...
                MaterialPageRoute(builder: (context) =>
                    GrowthChartScreen(childId: child.id ?? 0)),
              );
